    ...
    <div className="min-h-screen bg-black py-12 pt-36">
      ...
      <div className="flex flex-wrap justify-center gap-8">
        {courseData.courses.map((course) => (
          <CardContainer key={course.id} className="inter-var flex flex-col items-center">
            <CardBody className="bg-gray-50 relative group/card dark:hover:shadow-2xl dark:hover:shadow-emerald-500/[0.1] dark:bg-black dark:border-white/[0.2] border-black/[0.1] w-full sm:w-[30rem] h-auto rounded-xl p-6 border flex flex-col">
