...
export const StickyScroll = ({ content, contentClassName }) => {
  ...
  return (
    <motion.div
      ...
      className="h-[30rem] overflow-y-auto flex justify-center relative  rounded-md p-10"
      ref={ref}
    >
      ...
      <div style={{ background: backgroundGradient }} className={cn("hidden lg:block h-[20rem] w-[40rem] rounded-md bg-white sticky top-10 overflow-hidden", contentClassName)}>
